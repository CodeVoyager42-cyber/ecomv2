      ...
      <div className="px-6 py-16 sm:py-24 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="max-w-xl text-center md:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <button className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-gray-700 bg-white border-2 border-gray-200 rounded-xl shadow-md hover:shadow-lg will-change-transform hover:-translate-y-0.5 transition-all duration-200">
